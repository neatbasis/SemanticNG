...
- 2026-03-02 (Next): capability_id=capability_invocation_governance; Channel-agnostic decision/effect contract operational -> operational; capability status synchronized to `done` with policy-guard command-pack CI evidence. https://github.com/neatbasis/SemanticNG/actions/runs/19027411847
- 2026-03-02 (Later): capability_id=repair_aware_projection_evolution; Replay projection analytics contract operational -> operational; capability status synchronized to `done` with acceptance command-pack CI evidence linked in the manifest. https://github.com/neatbasis/SemanticNG/actions/runs/19041234567
