...
def test_parse_feature_doc_returns_none_when_gherkin_is_unavailable(monkeypatch) -> None:
...
def test_find_stable_ids_returns_empty_when_gherkin_is_unavailable(tmp_path, monkeypatch) -> None:
